...
namespace JonathonOH.Geometry
{
	public static class ConvexHullTransformExtensions
	{
		...
		/// </summary>
		public static ConvexPolygon TransformBy(this ConvexPolygon convexHull, Pose pose)
		{
			return new ConvexPolygon(TransformPoints(convexHull.Vertices, pose));
		}
		...
		/// Uses horizontal pose components (x, z).
		/// </summary>
		public static ConvexPolygon InverseTransformBy(this ConvexPolygon convexHull, Pose pose)
		{
			return new ConvexPolygon(InverseTransformPoints(convexHull.Vertices, pose));
		}
